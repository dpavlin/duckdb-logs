...
select 'tzk' as site,column0 as ip,column3 as ts,column5 as url,column6 as st,column7 as len,column8 as ref,column9 as ua from read_csv_auto('/zamd/cluster/ws1.net.ffzg.hr/1/log/nginx/access-tzk-ffzg-hr.log',delim=' ',ignore_errors=true,dateformat='%d/%b/%Y',timestampformat='[%d/%b/%Y:%H:%M:%S',filename=true);
